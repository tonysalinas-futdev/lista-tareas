...
from .views import ver_tareas, crear_tarea, ver_detalles, actualizar_tarea,completar_tarea, eliminar_tarea
...
urlpatterns = [
    ...
    path("completar_tarea/<int:tarea_id>", completar_tarea, name="completar")
